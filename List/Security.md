...
*   **[Tsunami Scanner](https://github.com/google/tsunami-security-scanner)** - General-purpose network security scanner with an extensible plugin system.
*   **[Vulhub](https://vulhub.org/)** - Pre-built vulnerable environments for security testing using Docker-Compose.
